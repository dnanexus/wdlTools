...
object ConcreteSyntax {
  ...
  case class ExprMapLiteral(value: Vector[ExprMember], text: TextSource) extends Expr
  case class ExprObjectLiteral(value: Vector[ExprMember], text: TextSource) extends Expr
