...
import org.openwdl.wdl.parser.v1_1.{WdlV1_1Parser, WdlV1_1ParserBaseVisitor}
import wdlTools.syntax.Antlr4Util.getSourceLocation
import wdlTools.syntax.v1_1.ConcreteSyntax._
import wdlTools.syntax.{CommentMap, Quoting, SourceLocation, SyntaxException, WdlVersion}

import scala.jdk.CollectionConverters._

case class ParseTop(grammar: WdlV1_1Grammar) extends WdlV1_1ParserBaseVisitor[Element] {
...
struct
	...
	;
   */
  override def visitStruct(ctx: WdlV1_1Parser.StructContext): TypeStruct = {
...
map_type
	...
	;
   */
  override def visitMap_type(ctx: WdlV1_1Parser.Map_typeContext): Type = {
...
array_type
	...
	;
   */
  override def visitArray_type(ctx: WdlV1_1Parser.Array_typeContext): Type = {
...
pair_type
	...
	;
   */
  override def visitPair_type(ctx: WdlV1_1Parser.Pair_typeContext): Type = {
...
type_base
	...
	;
   */
  override def visitType_base(ctx: WdlV1_1Parser.Type_baseContext): Type = {
...
wdl_type
  ...
  ;
   */
  override def visitWdl_type(ctx: WdlV1_1Parser.Wdl_typeContext): Type = {
  ...
  override def visitNumber(ctx: WdlV1_1Parser.NumberContext): Expr = {
  ...
  private def parse_placeholder_option(
    ...
    if (ctx.DEFAULTEQUAL() != null) {
      ...
      val expr: Expr = if (ctx.string() != null) {
        ctx.string() match {
          case sq: WdlV1_1Parser.Squote_stringContext => visitSquote_string(sq)
          case dq: WdlV1_1Parser.Dquote_stringContext => visitDquote_string(dq)
        }
      } else {
  ...
  private def parseEntirePlaceHolderExpression(options: Map[String, Expr],
    ...
    if (options.isEmpty) {
      ...
      if (placeholder.trueOpt.isDefined != placeholder.falseOpt.isDefined || placeholder.trueOpt.isDefined && placeholder.sepOpt.isDefined) {
...
string
  ...
  private def visitString(quoting: Quoting.Quoting,
                          stringParts: WdlV1_1Parser.String_partsContext,
                          stringExprWithStringPart: scala.collection.Seq[
                              WdlV1_1Parser.String_expr_with_string_partContext
                          ],
                          ctx: WdlV1_1Parser.StringContext): Expr = {
  ...
  override def visitSquote_string(ctx: WdlV1_1Parser.Squote_stringContext): Expr = {
    visitString(Quoting.Single, ctx.string_parts(), ctx.string_expr_with_string_part().asScala, ctx)
  }

  override def visitDquote_string(ctx: WdlV1_1Parser.Dquote_stringContext): Expr = {
  ...
  /* primitive_literal
    ...
    | Identifier
    ; */
  override def visitPrimitive_literal(ctx: WdlV1_1Parser.Primitive_literalContext): Expr = {
  ...
  override def visitLor(ctx: WdlV1_1Parser.LorContext): Expr = {
  ...
  override def visitLand(ctx: WdlV1_1Parser.LandContext): Expr = {
  ...
  override def visitEqeq(ctx: WdlV1_1Parser.EqeqContext): Expr = {
  ...
  override def visitLt(ctx: WdlV1_1Parser.LtContext): Expr = {
    val arg0 = visitExpr_infix2(ctx.expr_infix2())
    val arg1 = visitExpr_infix3(ctx.expr_infix3())
    ExprLt(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitGte(ctx: WdlV1_1Parser.GteContext): Expr = {
    val arg0 = visitExpr_infix2(ctx.expr_infix2())
    val arg1 = visitExpr_infix3(ctx.expr_infix3())
    ExprGte(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitNeq(ctx: WdlV1_1Parser.NeqContext): Expr = {
    val arg0 = visitExpr_infix2(ctx.expr_infix2())
    val arg1 = visitExpr_infix3(ctx.expr_infix3())
    ExprNeq(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitLte(ctx: WdlV1_1Parser.LteContext): Expr = {
    val arg0 = visitExpr_infix2(ctx.expr_infix2())
    val arg1 = visitExpr_infix3(ctx.expr_infix3())
    ExprLte(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitGt(ctx: WdlV1_1Parser.GtContext): Expr = {
    val arg0 = visitExpr_infix2(ctx.expr_infix2())
    val arg1 = visitExpr_infix3(ctx.expr_infix3())
    ExprGt(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitAdd(ctx: WdlV1_1Parser.AddContext): Expr = {
  ...
  override def visitSub(ctx: WdlV1_1Parser.SubContext): Expr = {
    val arg0 = visitExpr_infix3(ctx.expr_infix3())
    val arg1 = visitExpr_infix4(ctx.expr_infix4())
    ExprSub(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitMod(ctx: WdlV1_1Parser.ModContext): Expr = {
  ...
  override def visitMul(ctx: WdlV1_1Parser.MulContext): Expr = {
    val arg0 = visitExpr_infix4(ctx.expr_infix4())
    val arg1 = visitExpr_infix5(ctx.expr_infix5())
    ExprMul(arg0, arg1)(getSourceLocation(grammar.docSource, ctx))
  }

  override def visitDivide(ctx: WdlV1_1Parser.DivideContext): Expr = {
    val arg0 = visitExpr_infix4(ctx.expr_infix4())
    val arg1 = visitExpr_infix5(ctx.expr_infix5())
  ...
  override def visitExpression_group(ctx: WdlV1_1Parser.Expression_groupContext): Expr = {
    visitExpr(ctx.expr())
  }

  // | LBRACK (expr (COMMA expr)*)* RBRACK #array_literal
  override def visitArray_literal(ctx: WdlV1_1Parser.Array_literalContext): Expr = {
  ...
  override def visitPair_literal(ctx: WdlV1_1Parser.Pair_literalContext): Expr = {
  ...
  override def visitMap_literal(ctx: WdlV1_1Parser.Map_literalContext): Expr = {
    val elements = ctx
      .expr()
      .asScala
      .map(x => visitExpr(x))
  ...
  private def getMembers(members: Vector[WdlV1_1Parser.MemberContext],
                         values: Vector[WdlV1_1Parser.ExprContext],
  ...
  override def visitObject_literal(ctx: WdlV1_1Parser.Object_literalContext): Expr = {
  ...
  override def visitStruct_literal(ctx: WdlV1_1Parser.Struct_literalContext): Expr = {
  ...
  // | NOT expr #negate
  override def visitNegate(ctx: WdlV1_1Parser.NegateContext): Expr = {
  ...
  override def visitUnarysigned(ctx: WdlV1_1Parser.UnarysignedContext): Expr = {
    val expr = visitExpr_infix5(ctx.expr_infix5())
  ...
  override def visitAt(ctx: WdlV1_1Parser.AtContext): Expr = {
  ...
  override def visitApply(ctx: WdlV1_1Parser.ApplyContext): Expr = {
  ...
  override def visitIfthenelse(ctx: WdlV1_1Parser.IfthenelseContext): Expr = {
    val elements = ctx
      .expr()
      .asScala
      .map(x => visitExpr(x))
  ...
  override def visitLeft_name(ctx: WdlV1_1Parser.Left_nameContext): Expr = {
  ...
  override def visitGet_name(ctx: WdlV1_1Parser.Get_nameContext): Expr = {
  ...
  private def visitExpr_infix0(ctx: WdlV1_1Parser.Expr_infix0Context): Expr = {
    ctx match {
      case lor: WdlV1_1Parser.LorContext => visitLor(lor)
      case infix1: WdlV1_1Parser.Infix1Context =>
  ...
  /* expr_infix1
	...
	| expr_infix2 #infix2
	; */
  private def visitExpr_infix1(ctx: WdlV1_1Parser.Expr_infix1Context): Expr = {
    ctx match {
      case land: WdlV1_1Parser.LandContext     => visitLand(land)
      case infix2: WdlV1_1Parser.Infix2Context => visitInfix2(infix2).asInstanceOf[Expr]
    }
  }
  ...
  private def visitExpr_infix2(ctx: WdlV1_1Parser.Expr_infix2Context): Expr = {
    ctx match {
      case eqeq: WdlV1_1Parser.EqeqContext => visitEqeq(eqeq)
      case neq: WdlV1_1Parser.NeqContext   => visitNeq(neq)
      case lte: WdlV1_1Parser.LteContext   => visitLte(lte)
      case gte: WdlV1_1Parser.GteContext   => visitGte(gte)
      case lt: WdlV1_1Parser.LtContext     => visitLt(lt)
      case gt: WdlV1_1Parser.GtContext     => visitGt(gt)
      case infix3: WdlV1_1Parser.Infix3Context =>
  ...
  /* expr_infix3
	...
	| expr_infix4 #infix4
	; */
  private def visitExpr_infix3(ctx: WdlV1_1Parser.Expr_infix3Context): Expr = {
    ctx match {
      case add: WdlV1_1Parser.AddContext => visitAdd(add)
      case sub: WdlV1_1Parser.SubContext => visitSub(sub)
      case infix4: WdlV1_1Parser.Infix4Context =>
  ...
  /* expr_infix4
	...
	| expr_infix5 #infix5
	;  */
  private def visitExpr_infix4(ctx: WdlV1_1Parser.Expr_infix4Context): Expr = {
    ctx match {
      case mul: WdlV1_1Parser.MulContext       => visitMul(mul)
      case divide: WdlV1_1Parser.DivideContext => visitDivide(divide)
      case mod: WdlV1_1Parser.ModContext       => visitMod(mod)
      case infix5: WdlV1_1Parser.Infix5Context => visitInfix5(infix5).asInstanceOf[Expr]
    }
  }
  ...
  private def visitExpr_infix5(ctx: WdlV1_1Parser.Expr_infix5Context): Expr = {
    ctx match {
      case negate: WdlV1_1Parser.NegateContext           => visitNegate(negate)
      case unarysigned: WdlV1_1Parser.UnarysignedContext => visitUnarysigned(unarysigned)
      case infix6: WdlV1_1Parser.Infix6Context           => visitInfix6(infix6).asInstanceOf[Expr]
    }
  }

  override def visitExpr_infix6(ctx: WdlV1_1Parser.Expr_infix6Context): Expr = {
  ...
  /* expr
    : expr_infix
    ; */
  override def visitExpr(ctx: WdlV1_1Parser.ExprContext): Expr = {
    try {
  ...
  /* expr_core
	...
	| expr_core DOT Identifier #get_name
	; */
  private def visitExpr_core(ctx: WdlV1_1Parser.Expr_coreContext): Expr = {
    ctx match {
      case group: WdlV1_1Parser.Expression_groupContext => visitExpression_group(group)
      case primitives: WdlV1_1Parser.PrimitivesContext =>
        visitPrimitive_literal(primitives.primitive_literal())
      case array_literal: WdlV1_1Parser.Array_literalContext => visitArray_literal(array_literal)
      case pair_literal: WdlV1_1Parser.Pair_literalContext   => visitPair_literal(pair_literal)
      case map_literal: WdlV1_1Parser.Map_literalContext     => visitMap_literal(map_literal)
      case object_literal: WdlV1_1Parser.Object_literalContext =>
        visitObject_literal(object_literal)
      case struct_literal: WdlV1_1Parser.Struct_literalContext =>
        visitStruct_literal(struct_literal)
      case at: WdlV1_1Parser.AtContext                 => visitAt(at)
      case ifthenelse: WdlV1_1Parser.IfthenelseContext => visitIfthenelse(ifthenelse)
      case apply: WdlV1_1Parser.ApplyContext           => visitApply(apply)
      case left_name: WdlV1_1Parser.Left_nameContext   => visitLeft_name(left_name)
      case get_name: WdlV1_1Parser.Get_nameContext     => visitGet_name(get_name)
      case _ =>
...
unbound_decls
	...
	;
   */
  override def visitUnbound_decls(ctx: WdlV1_1Parser.Unbound_declsContext): Declaration = {
...
bound_decls
	...
	;
   */
  override def visitBound_decls(ctx: WdlV1_1Parser.Bound_declsContext): Declaration = {
    if (ctx.wdl_type() == null) {
      throw new SyntaxException("unrecognized type", getSourceLocation(grammar.docSource, ctx))
    }
...
any_decls
	...
	;
   */
  override def visitAny_decls(ctx: WdlV1_1Parser.Any_declsContext): Declaration = {
  ...
  /* meta_value
    ...
    | NULL_LITERAL
    ; */
  override def visitMeta_value(ctx: WdlV1_1Parser.Meta_valueContext): MetaValue = {
    if (ctx.MetaNull() != null) {
      ...
      ctx.meta_string() match {
        case sq: WdlV1_1Parser.Meta_squote_stringContext => visitMeta_squote_string(sq)
        case dq: WdlV1_1Parser.Meta_dquote_stringContext => visitMeta_dquote_string(dq)
      }
  ...
  override def visitMeta_squote_string(
      ctx: WdlV1_1Parser.Meta_squote_stringContext
  ): MetaValueString = {
  ...
  override def visitMeta_dquote_string(
      ctx: WdlV1_1Parser.Meta_dquote_stringContext
  ): MetaValueString = {
    val s = visitMeta_string_parts(ctx.meta_string_parts())
   ...
   */
  override def visitMeta_array(ctx: WdlV1_1Parser.Meta_arrayContext): MetaValueArray = {
  ...
  private def visitMeta_kv(identifier: TerminalNode,
                           meta_value: WdlV1_1Parser.Meta_valueContext,
   ...
   */
  override def visitMeta_object(ctx: WdlV1_1Parser.Meta_objectContext): MetaValueObject = {
    val members = ctx
      .meta_object_kv()
      .asScala
      .toVector
  ...
  /* meta_kv
     ...
     ; */
  override def visitMeta_kv(ctx: WdlV1_1Parser.Meta_kvContext): MetaKV = {
  ...
  override def visitParameter_meta(
      ctx: WdlV1_1Parser.Parameter_metaContext
  ...
  override def visitMeta(ctx: WdlV1_1Parser.MetaContext): MetaSection = {
    val kvs: Vector[MetaKV] = ctx
      .meta_kv()
      .asScala
      .map(x => visitMeta_kv(x))
  ...
  /* task_runtime_kv
   : Identifier COLON expr
   ; */
  override def visitTask_runtime_kv(ctx: WdlV1_1Parser.Task_runtime_kvContext): RuntimeKV = {
 ...
 ; */
  override def visitTask_runtime(ctx: WdlV1_1Parser.Task_runtimeContext): RuntimeSection = {
    val kvs = ctx
      .task_runtime_kv()
      .asScala
...
task_input
	...
	;
   */
  override def visitTask_input(ctx: WdlV1_1Parser.Task_inputContext): InputSection = {
    val decls = ctx
      .any_decls()
      .asScala
  ...
  /* task_output
	...
	; */
  override def visitTask_output(ctx: WdlV1_1Parser.Task_outputContext): OutputSection = {
    val decls = ctx
      .bound_decls()
      .asScala
  ...
  /* task
	...
	;  */
  override def visitTask(ctx: WdlV1_1Parser.TaskContext): Task = {
  ...
  def visitImport_addr(ctx: WdlV1_1Parser.StringContext): ImportAddr = {
  ...
  /* import_alias
	...
	;*/
  override def visitImport_alias(ctx: WdlV1_1Parser.Import_aliasContext): ImportAlias = {
    val ids = ctx
      .Identifier()
      .asScala
      .map(x => x.getText)
  ...
  /*
    import_as
        ...
        ;
   */
  override def visitImport_as(ctx: WdlV1_1Parser.Import_asContext): ImportName = {
 ...
 import_doc
	...
	;
   */
  override def visitImport_doc(ctx: WdlV1_1Parser.Import_docContext): ImportDoc = {
  ...
  override def visitCall_after(ctx: WdlV1_1Parser.Call_afterContext): CallAfter = {
  ...
  /* call_alias
    : AS Identifier
    ; */
  override def visitCall_alias(ctx: WdlV1_1Parser.Call_aliasContext): CallAlias = {
  ...
  /* call_input
	...
	; */
  override def visitCall_input(ctx: WdlV1_1Parser.Call_inputContext): CallInput = {
    val id = getIdentifierText(ctx.Identifier(), ctx)
    val loc = getSourceLocation(grammar.docSource, ctx)
  ...
  /* call_inputs
	...
	; */
  override def visitCall_inputs(ctx: WdlV1_1Parser.Call_inputsContext): CallInputs = {
  ...
  /* call_body
	...
	; */
  override def visitCall_body(ctx: WdlV1_1Parser.Call_bodyContext): CallInputs = {
  ...
  /* call
	...
	; */
  override def visitCall(ctx: WdlV1_1Parser.CallContext): Call = {
...
scatter
 ...
 ; */
  override def visitScatter(ctx: WdlV1_1Parser.ScatterContext): Scatter = {
    val id = getIdentifierText(ctx.Identifier(), ctx)
    val expr = visitExpr(ctx.expr())
    val body = ctx
  ...
  /* conditional
	...
	; */
  override def visitConditional(ctx: WdlV1_1Parser.ConditionalContext): Conditional = {
    val expr = visitExpr(ctx.expr())
    val body = ctx
      .inner_workflow_element()
      .asScala
  ...
  /* workflow_input
	: INPUT LBRACE (any_decls)* RBRACE
	; */
  override def visitWorkflow_input(ctx: WdlV1_1Parser.Workflow_inputContext): InputSection = {
    val decls = ctx
      .any_decls()
      .asScala
      .map(x => visitAny_decls(x))
  ...
  /* workflow_output
	...
	;
   */
  override def visitWorkflow_output(ctx: WdlV1_1Parser.Workflow_outputContext): OutputSection = {
    val decls = ctx
      .bound_decls()
      .asScala
      .map(x => visitBound_decls(x))
...
workflow
	...
	;
   */
  override def visitWorkflow(ctx: WdlV1_1Parser.WorkflowContext): Workflow = {
    val name = getIdentifierText(ctx.Identifier(), ctx)
    val elems: Vector[WdlV1_1Parser.Workflow_elementContext] =
      ctx.workflow_element().asScala.toVector

    val input: Option[InputSection] = atMostOneSection(elems.collect {
                                                         case x: WdlV1_1Parser.InputContext =>
    ...
    val output: Option[OutputSection] = atMostOneSection(
        elems.collect {
          case x: WdlV1_1Parser.OutputContext =>
            visitWorkflow_output(x.workflow_output())
        },
        "output",
        ctx)
    val meta: Option[MetaSection] = atMostOneSection(elems.collect {
                                                       case x: WdlV1_1Parser.Meta_elementContext =>
                                                         visitMeta(x.meta())
                                                     },
                                                     "meta",
                                                     ctx)
    val parameterMeta: Option[ParameterMetaSection] = atMostOneSection(
        elems.collect {
          case x: WdlV1_1Parser.Parameter_meta_elementContext =>
            visitParameter_meta(x.parameter_meta())
        },
        "parameter_meta",
        ctx)
    val wfElems: Vector[WorkflowElement] = elems.collect {
      case x: WdlV1_1Parser.Inner_elementContext =>
...
document_element
  ...
  override def visitDocument_element(
      ctx: WdlV1_1Parser.Document_elementContext
  ): DocumentElement = {
  ...
  /* version
	...
	; */
  override def visitVersion(ctx: WdlV1_1Parser.VersionContext): Version = {
...
document
	...
	;
   */
  def visitDocument(ctx: WdlV1_1Parser.DocumentContext, comments: CommentMap): Document = {
  ...
  def visitExprDocument(ctx: WdlV1_1Parser.Expr_documentContext): Expr = {
    visitExpr(ctx.expr())
  }

  def visitTypeDocument(ctx: WdlV1_1Parser.Type_documentContext): Type = {
    visitWdl_type(ctx.wdl_type())
  }

  def parseDocument: Document = {
    grammar
      .visitDocument[WdlV1_1Parser.DocumentContext, Document](grammar.parser.document,
                                                              visitDocument)
  }

  def parseExpr: Expr = {
    grammar.visitFragment[WdlV1_1Parser.Expr_documentContext, Expr](grammar.parser.expr_document,
                                                                    visitExprDocument)
  }

  def parseWdlType: Type = {
    grammar.visitFragment[WdlV1_1Parser.Type_documentContext, Type](grammar.parser.type_document,
                                                                    visitTypeDocument)
  }
}
