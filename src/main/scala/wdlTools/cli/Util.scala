...
object Util {
  ...
  class Conf(args: Seq[String]) extends ScallopConf(args) {
    ...
    def getSyntaxConf(merge: Set[Path]): syntax.Util.Conf = {
      syntax.Util.Conf(localDirectories = this.localDirectories(merge),
  ...
  def readFromUri(uri: URI, conf: Conf): (Path, String) = {
