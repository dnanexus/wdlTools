...
import wdlTools.syntax.{Builtins, Operator, WdlVersion}
...
case class Stdlib(regime: TypeCheckingRegime,
  ...
  private lazy val draft2Prototypes: Vector[T_Function] = Vector(
      ...
      Vector(
          T_Function0(Builtins.Stdout, T_File),
          T_Function0(Builtins.Stderr, T_File),
          // Even though String -> non-String coercion is not generally
          // allowed, the spec explicitly says the results of read_lines
          // can be auto-coerced to any other primitive type. We enable
          // that by making the return type an array of T_Any.
          T_Function1(Builtins.ReadLines, T_File, T_Array(T_Any)),
          T_Function1(Builtins.ReadTsv, T_File, T_Array(T_Array(T_String))),
          T_Function1(Builtins.ReadMap, T_File, T_Map(T_String, T_String)),
          T_Function1(Builtins.ReadObject, T_File, T_Object),
          T_Function1(Builtins.ReadObjects, T_File, T_Array(T_Object)),
          T_Function1(Builtins.ReadJson, T_File, T_Any),
          T_Function1(Builtins.ReadInt, T_File, T_Int),
          T_Function1(Builtins.ReadString, T_File, T_String),
          T_Function1(Builtins.ReadFloat, T_File, T_Float),
          T_Function1(Builtins.ReadBoolean, T_File, T_Boolean),
          T_Function1(Builtins.WriteLines, T_Array(T_String), T_File),
          T_Function1(Builtins.WriteTsv, T_Array(T_Array(T_String)), T_File),
          T_Function1(Builtins.WriteMap, T_Map(T_String, T_String), T_File),
          T_Function1(Builtins.WriteObject, T_Object, T_File),
          T_Function1(Builtins.WriteObjects, T_Array(T_Object), T_File),
          T_Function1(Builtins.WriteJson, T_Any, T_File),
          T_Function1(Builtins.Size, T_Optional(T_File), T_Float),
          // Size takes an optional units parameter (KB, KiB, MB, GiB, ...)
          T_Function2(Builtins.Size, T_Optional(T_File), T_String, T_Float),
          T_Function3(Builtins.Sub, T_String, T_String, T_String, T_String),
          T_Function1(Builtins.Range, T_Int, T_Array(T_Int)),
          // Array[Array[X]] transpose(Array[Array[X]])
          T_Function1(Builtins.Transpose, T_Array(T_Array(T_Var(0))), T_Array(T_Array(T_Var(0)))),
          // Array[Pair(X,Y)] zip(Array[X], Array[Y])
          T_Function2(Builtins.Zip,
                      T_Array(T_Var(0)),
                      T_Array(T_Var(1)),
                      T_Array(T_Pair(T_Var(0), T_Var(1)))),
          // Array[Pair(X,Y)] cross(Array[X], Array[Y])
          T_Function2(Builtins.Cross,
                      T_Array(T_Var(0)),
                      T_Array(T_Var(1)),
                      T_Array(T_Pair(T_Var(0), T_Var(1)))),
          // Integer length(Array[X])
          T_Function1(Builtins.Length, T_Array(T_Var(0)), T_Int),
          // Array[X] flatten(Array[Array[X]])
          T_Function1(Builtins.Flatten, T_Array(T_Array(T_Var(0))), T_Array(T_Var(0))),
          T_Function2(Builtins.Prefix,
                      T_String,
                      T_Array(T_Var(0, TypeUtils.PrimitiveTypes)),
                      T_Array(T_String)),
          T_Function1(Builtins.SelectFirst, T_Array(T_Optional(T_Var(0))), T_Var(0)),
          T_Function1(Builtins.SelectAll, T_Array(T_Optional(T_Var(0))), T_Array(T_Var(0))),
          T_Function1(Builtins.Defined, T_Optional(T_Var(0)), T_Boolean),
          T_Function1(Builtins.Basename, T_String, T_String),
          T_Function2(Builtins.Basename, T_String, T_String, T_String),
          T_Function1(Builtins.Floor, T_Float, T_Int),
          T_Function1(Builtins.Ceil, T_Float, T_Int),
          T_Function1(Builtins.Round, T_Float, T_Int),
          // not mentioned in the specification
          T_Function1(Builtins.Glob, T_String, T_Array(T_File))
      )
  ).flatten
  ...
  private lazy val v1Prototypes: Vector[T_Function] = Vector(
      ...
      Vector(
          ...
          T_Function1(Builtins.WriteJson, T_Any, T_File),
          T_Function1(Builtins.Size, T_Optional(T_File), T_Float),
          T_Function1(Builtins.Size, T_Array(T_File), T_Float),
          // Size takes an optional units parameter (KB, KiB, MB, GiB, ...)
          T_Function2(Builtins.Size, T_Optional(T_File), T_String, T_Float),
          T_Function2(Builtins.Size, T_Array(T_File), T_String, T_Float),
          T_Function3(Builtins.Sub, T_String, T_String, T_String, T_String),
          T_Function1(Builtins.Range, T_Int, T_Array(T_Int)),
          // Array[Array[X]] transpose(Array[Array[X]])
          T_Function1(Builtins.Transpose, T_Array(T_Array(T_Var(0))), T_Array(T_Array(T_Var(0)))),
  ...
  private lazy val v1_1Prototypes: Vector[T_Function] = Vector(
      ...
      Vector(
          ...
          T_Function1(Builtins.Ceil, T_Float, T_Int),
          T_Function1(Builtins.Round, T_Float, T_Int),
          T_Function2(Builtins.Min, T_Int, T_Int, T_Int),
          T_Function2(Builtins.Min, T_Int, T_Float, T_Float),
          T_Function2(Builtins.Min, T_Float, T_Int, T_Float),
          T_Function2(Builtins.Min, T_Float, T_Float, T_Float),
          T_Function2(Builtins.Max, T_Int, T_Int, T_Int),
          T_Function2(Builtins.Max, T_Int, T_Float, T_Float),
          T_Function2(Builtins.Max, T_Float, T_Int, T_Float),
          T_Function2(Builtins.Max, T_Float, T_Float, T_Float),
          T_Function3(Builtins.Sub, T_String, T_String, T_String, T_String),
          T_Function0(Builtins.Stdout, T_File),
          T_Function0(Builtins.Stderr, T_File),
          T_Function1(Builtins.Glob, T_String, T_Array(T_File)),
          ...
          T_Function1(Builtins.WriteJson, T_Any, T_File),
          T_Function1(Builtins.Size, T_Optional(T_File), T_Float),
          T_Function1(Builtins.Size, T_Array(T_Optional(T_File)), T_Float),
          T_Function2(Builtins.Size, T_Optional(T_File), T_String, T_Float),
          T_Function2(Builtins.Size, T_Array(T_Optional(T_File)), T_String, T_Float),
          T_Function1(Builtins.Length, T_Array(T_Var(0)), T_Int), // TODO: can the type be T_Any?
          T_Function1(Builtins.Range, T_Int, T_Array(T_Int)),
          T_Function1(Builtins.Transpose, T_Array(T_Array(T_Var(0))), T_Array(T_Array(T_Var(0)))),
          T_Function2(Builtins.Zip,
                      T_Array(T_Var(0)),
          ...
          T_Function2(Builtins.Prefix,
                      ...
                      T_Array(T_Var(0, TypeUtils.PrimitiveTypes)),
                      T_Array(T_String)),
          T_Function2(Builtins.Suffix,
                      T_String,
                      T_Array(T_Var(0, TypeUtils.PrimitiveTypes)),
                      T_Array(T_String)),
          T_Function1(Builtins.Quote,
                      T_Array(T_Var(0, TypeUtils.PrimitiveTypes)),
                      T_Array(T_String)),
          T_Function1(Builtins.Squote,
                      T_Array(T_Var(0, TypeUtils.PrimitiveTypes)),
                      T_Array(T_String)),
          T_Function2(Builtins.Sep, T_String, T_Array(T_String), T_String),
          T_Function1(Builtins.AsPairs,
                      T_Map(T_Var(0), T_Var(1)),
                      T_Array(T_Pair(T_Var(0), T_Var(1)))),
          T_Function1(Builtins.AsMap,
                      T_Array(T_Pair(T_Var(0), T_Var(1))),
                      T_Map(T_Var(0), T_Var(1))),
          T_Function1(Builtins.Keys, T_Map(T_Var(0), T_Any), T_Array(T_Var(0))),
          T_Function1(Builtins.CollectByKey,
                      T_Array(T_Pair(T_Var(0), T_Var(1))),
