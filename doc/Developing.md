...
wdlTools depends on parsers for each WDL version, which are generated by ANTLR4. The first time you build wdlTools, as well as any time you change the parser grammar, you need to regenerate the parser classes. To do so, run:
