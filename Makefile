...
download_antlr_jar:
	(if [ ! -e ${ROOT_DIR}/antlr-4.9-complete.jar ]; then \
...
v1_1 :
	(cd ${ROOT_DIR}/src/main/antlr4/v1_1; java -jar ${ROOT_DIR}/antlr-4.8-complete.jar -o ${ROOT_DIR}/src/main/java -visitor -package org.openwdl.wdl.parser.v1_1 WdlV1_1Parser.g4 WdlV1_1Lexer.g4)
